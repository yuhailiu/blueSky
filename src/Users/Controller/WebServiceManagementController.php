...
class WebServiceManagementController extends CommController
{
    ...
    public function clearTargetsByUserAction()
    {
        MyUtils::inspector();
        MyUtils::inspector1();
        ...
        try {
            $this->clearTargtsByUser();
            $flag = "successClearTargets";
        } catch (\Exception $e) {
    ...
    protected function clearTargtsByUser()
    {
        $user = $this->user;
        $sql = "DELETE from target where target_creater ='$user->id'";
